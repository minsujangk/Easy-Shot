...
public class ImageDatabaseManager {
    ...
    *   */
    ...
    public ArrayList<Item> search(String entry, ArrayList<String> value) {
        String[] projection = {
        ...
        while (c.isAfterLast()) {
            ...
            Item item = new Item(c.getInt(c.getColumnIndexOrThrow(TableEntry._ID)),
    ...
    /*
    * 데이터베이스에서 entry가 value와 일치하는 row를 찾아서 ArrayList<Item>으로 반환한다.
    *
    * Input
    *   entry   : 찾을 Item의 타입
    *   value   : 값의 ArrayList
